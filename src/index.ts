...
async function main() {
  ...
  // No console output — MCP communicates via stdio, anything on stdout would
  // corrupt the protocol. Errors land on stderr via the SDK.
}
